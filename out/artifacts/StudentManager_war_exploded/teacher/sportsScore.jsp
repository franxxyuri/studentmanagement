...
<div id="page" class="container">
    <div id="header">
        ...
        <div id="menu">
            <ul>
                <li><a href="personal.ranking">个人信息</a></li>
    ...
    <div id="main">
        <div class="top">
            <h2>学生运动会信息管理</h2>
            <button class="btn-add">添加学生成绩</button
            <input type="button" class="btn-add" onclick="location.href='sportsScore_excel.jsp';" value="导出EXCEL">
            <hr/>
        </div>
            ...
            <table id="table" width="800" frame="box" align="center">
                ...
                <tr>
                    ...
                    <td> <a class="btn-delete" onclick="return confirm('确定要删除吗?');"
                                                                                      href=<%="'../delete_sportsScore?id=" + stu.getId() + "'"%>>删除</a>&nbsp;&nbsp;<a href="../one_page_sportsscore?id=<%=stu.getId()%>">查看成绩</a>
                    </td>
                </tr>
                <%
                        }
